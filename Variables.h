...
int check = 0;              // счетчик "нужна ли предыдущ. коорд. курсора"

int millis = 10;            // частота обновления экрана